...
void main() {
  ...
  _requireDirectories(
    <String>[
      ...
      'apps/example/lib/src/app/di',
      'apps/example/lib/src/app/router',
      'apps/example/lib/src/features/showcase/data',
      'apps/example/lib/src/features/showcase/domain/models',
      'apps/example/lib/src/features/showcase/domain/repositories',
      ...
      'apps/example/lib/src/features/showcase/presentation/state',
  ...
  _requireFiles(
    <String>[
      ...
      'apps/example/lib/src/app/bootstrap.dart',
      'apps/example/lib/src/app/example_app.dart',
      'apps/example/lib/src/app/di/app_dependencies.dart',
      'apps/example/lib/src/app/router/app_router.dart',
      'apps/example/lib/src/app/router/app_routes.dart',
      ...
      'apps/example/lib/src/features/showcase/domain/repositories/showcase_repository.dart',
      ...
      'apps/example/lib/src/features/showcase/presentation/state/showcase_state.dart',
      'apps/example/test/app/example_app_test.dart',
      'apps/example/test/features/showcase/data/showcase_catalog_test.dart',
      'apps/example/test/features/showcase/presentation/controllers/showcase_controller_test.dart',
  ...
  _forbidImports(
    Directory('apps/example/lib/src/features/showcase/presentation'),
    <String>[
      '../../data/',
      '../data/',
    ],
